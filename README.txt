...
a persistence unit "pegacorn-communicate-iris-msgprocessorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pegacorn-communicate-iris-msgprocessor\pom.xml":
...
artifact ("pegacorn-communicate-iris-msgprocessor.war") is already built. You can build
