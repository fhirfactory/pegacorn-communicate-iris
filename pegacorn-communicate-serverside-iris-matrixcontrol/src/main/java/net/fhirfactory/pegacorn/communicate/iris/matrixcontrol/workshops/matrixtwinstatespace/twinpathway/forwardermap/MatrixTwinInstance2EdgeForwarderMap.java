package net.fhirfactory.pegacorn.communicate.iris.matrixcontrol.workshops.matrixtwinstatespace.twinpathway.forwardermap;
...
@ApplicationScoped
public class MatrixTwinInstance2EdgeForwarderMap {
    private static final Logger LOG = LoggerFactory.getLogger(MatrixTwinInstance2EdgeForwarderMap.class);

    ConcurrentHashMap<MTIdentifier, HashSet<String>> forwarderMap;

    public MatrixTwinInstance2EdgeForwarderMap(){
        forwarderMap = new ConcurrentHashMap<>();
    }

    public void addForwarderAssociation2DigitalTwin(String forwarderName, MTIdentifier twinIdentifier){
    ...
    public void removeForwarderAssociation2DigitalTwin(String forwarderName, MTIdentifier twinIdentifier){
    ...
    public Set<String> getForwarderAssociation2DigitalTwin(MTIdentifier twinIdentifier){
